    ...
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["shopping_cart"] as $keys => $values) {
            if ($values["item_id"] == $_GET["id"]) {
                ...
                echo '<script>window.location="CAclientspage.php"</script>';
            }
        }
    }
}
...
<?php
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="CAclientspage.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                                                </tr>
                                            <?php
                                                $total = $total + ($values["item_quantity"] * $values["item_price"]);
                                            }
                            ...
                            <div class="container">
                                ...
                                ?>
                                        ...
                                        <form method="post" action="CAclientspage.php?action=add&id=<?php echo $row["id"]; ?>">
                                            <div class="col-md-4">
                                                <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
                                                    <img src="images/<?php echo $row["image"]; ?>" class="img-responsive" width="200px;" height="200px;" style ="border-radius: 50%;" alt="Image" /><br />
